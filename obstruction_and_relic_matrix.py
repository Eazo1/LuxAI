...
class SymmetricMatrix:
  ...
  def get_entangled_index(self, i, j):
    return self.size - j, self.size - i
...
class GrandObstructionMatrix(SymmetricMatrix):
  ...
  def get_entangled_iteration_index(self, iteration_i, iteration_j):
    return 24 - iteration_j, 24 - iteration_i
  ...
  def get_obstruction_matrix_iteration (grand_obstruction_matrix, map_iteration_period, time_iteration):
    total_size = grand_obstruction_matrix.size()
    
    obstruction_movement_step = time_iteration // map_iteration_period # make sure // is correct here (for the game)
    
    if obstruction_direction == 1:
      obstruction_matrix_iteration = grand_obstruction_matrix[(total_size - 24 - obstruction_movement_step) : (total_size - obstruction_movement_step),
                                                              (obstruction_movement_step) : (24 + obstruction_movement_step)]
    else:
      obstruction_matrix_iteration = grand_obstruction_matrix[(obstruction_movement_step) : (24 + obstruction_movement_step),
